  ...
  return (
    <section className="bg-black py-14 px-8">
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* One-Time */}
        <div className="bg-stone-200 rounded-xl p-7 text-stone-900">
          ...
          <form action="/api/donations" method="POST">
        ...
        <div className="bg-stone-200 rounded-xl p-7 text-stone-900">
          ...
          <a
            ...
            className="block text-center w-full bg-purple-700 text-white rounded-full py-2.5 hover:bg-purple-800"
          >
            Explore
          </a>
        </div>
